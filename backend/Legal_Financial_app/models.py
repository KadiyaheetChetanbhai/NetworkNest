...
class Financial(models.Model):
    Financial_id = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, primary_key=True,related_name='Legal_Financial_as_Legal_Financial_id')
